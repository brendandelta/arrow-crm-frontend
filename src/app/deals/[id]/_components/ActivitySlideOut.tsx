...
const ACTIVITY_KINDS = [
  ...
  { value: "sms", label: "SMS", icon: MessageSquare, color: "text-muted-foreground", bgColor: "bg-muted" },
            ...
            <div className="py-2">
              ...
              {showTimeFields && (
                <div className="mt-2">
                  <div className="flex items-center gap-2 mb-1 px-3">
                    <Calendar className="h-3.5 w-3.5 text-muted-foreground" />
                    <span className="text-xs font-medium text-muted-foreground uppercase tracking-wide">End Time</span>
                  </div>
                  <input
                    type="datetime-local"
            ...
            <div className="py-2">
              ...
              {formData.isTask && (
                <div className="mt-2">
                  <div className="flex items-center gap-2 mb-1 px-3">
                    <Calendar className="h-3.5 w-3.5 text-muted-foreground" />
                    <span className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Task Due Date</span>
                  </div>
                  <input
                    type="date"
