...
export function BulkActionBar({ selectedPeople, onClear }: BulkActionBarProps) {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-slate-800 px-3 py-2.5 rounded-lg shadow-xl flex items-center gap-3 z-50">
      <span className="text-sm text-slate-300 pr-3 border-r border-slate-600">
      ...
      <div className="flex items-center gap-2">
        {emails.length > 0 && (
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 text-sm text-blue-300 hover:text-blue-200 hover:bg-slate-700 rounded-md transition-colors"
          >
        ...
        {phones.length > 0 && (
          <>
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 text-sm text-slate-300 hover:text-slate-100 hover:bg-slate-700 rounded-md transition-colors"
            >
              {copiedPhones ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 text-sm text-green-400 hover:text-green-300 hover:bg-slate-700 rounded-md transition-colors"
            >
