  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/people`)
      ...
      .then((data) => {
        ...
        setPeople(allPeople.filter((p: Person) => p.warmth === 2));
        setLoading(false);
      })
      .catch((err) => {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold">Hot Contacts</h1>
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-orange-100 flex items-center justify-center text-xs font-medium text-orange-700">
